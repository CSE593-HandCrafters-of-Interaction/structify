...
export function SettingsView({ open, onOpenChange }: SettingsViewProps) {
  ...
  const getProviderIcon = (provider: ModelProvider) => {
    switch (provider) {
      ...
      case "mistral":
        return (
          <div className="size-4 rounded bg-[#FF6B35] flex items-center justify-center">
            <span className="text-[10px] font-bold text-white">M</span>
          </div>
        );
      case "cohere":
        return (
          <div className="size-4 rounded bg-[#FF6D5A] flex items-center justify-center">
            <span className="text-[10px] font-bold text-white">C</span>
          </div>
        );
      case "xai":
        return (
          <div className="size-4 rounded bg-black flex items-center justify-center">
